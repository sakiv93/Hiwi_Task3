...
c~       write(6,*) "Gauss Points"
c~       do i = 1, size(wg,1)
c~             write(6,'(20G12.4)') wg(i,:)
c~       end do
...
c....................(End Extended for 3D).....................c
      ...
      enddo
        ...
        call trans_matrix01(Tra,Trb,Trc,xy0) !??? Have to see what is xy0 here ???!
        call material_matrix01(cmat,kapmat,grdmat,xy0,B) !??? Have to see what is xy0 here ???!
...
c....... The summation of Gaussian points
     ...
     $       xy0,uelem,B) !??? Have to see what is xy0 here ???!
...
c~       write(6,*) "Kuu Matrix"
c~       do i = 1, size(Kuu,1)
c~             write(6,'(20G12.4)') Kuu(i,:)
c~       end do
...
c~       write(6,*) "Kpu Matrix"
c~       do i = 1, size(Kpu,1)
c~             write(6,'(20G12.4)') Kpu(i,:)
c~       end do
...
c~       write(6,*) "Kup Matrix"
c~       do i = 1, size(Kup,1)
c~             write(6,'(20G12.4)') Kup(i,:)
c~       end do
...
c~       write(6,*) "Bphi Matrix"
c~       do i = 1, size(Bphi,1)
c~             write(6,'(20G12.4)') Bphi(i,:)
c~       end do
...
c~       write(6,*) "Kphi Matrix"
c~       do i = 1, size(Kphi,1)
c~             write(6,'(20G12.4)') Kphi(i,:)
c~       end do
...
c~       write(6,*) "Kphip Matrix"
c~       do i = 1, size(Kphip,1)
c~             write(6,'(20G12.4)') Kphip(i,:)
c~       end do
...
c~       write(6,*) "Kpp Matrix"
c~       do i = 1, size(Kpp,1)
c~             write(6,'(20G12.4)') Kpp(i,:)
c~       end do
...
c~       write(6,*) "Ke2 Matrix"
c~       do i = 1, size(Ke2,1)
c~             write(6,'(20G12.4)') Ke2(i,:)
c~       end do
...
c~       write(6,*) "AMATRX"
c~       do i = 1, size(AMATRX,1)
c~           write(6,'(40G12.4)')  AMATRX(i,:)
c~       end do
c~       write(6,*) "RHS"
c~       do i = 1, 56
c~         write(6,*) RHS(i,1)
...
c~       write(6,*) "Shape Functions"
c~       do i = 1, size(shp,1)
c~           write(6,'(40G12.4)')  shp(i,:)
c~       end do
...
c~       write(6,*) "qmat before transformation"
c~       do i = 1, size(qmat,1)
c~           write(6,'(40G12.4)')  qmat(i,:)
c~       end do
...
c~       write(6,*) "qmat after transformation"
c~       do i = 1, size(qmat,1)
c~           write(6,'(40G12.4)')  qmat(i,:)
c~       end do
...
c~       write(6,*) "alfamat before transformation"
c~       do i = 1, size(alfamat,1)
c~           write(6,'(40G12.4)')  alfamat(i,:)
c~       end do
...
c~       write(6,*) "alfamat after transformation"
c~       do i = 1, size(alfamat,1)
c~           write(6,'(40G12.4)')  alfamat(i,:)
c~       end do
      return 
...
c~       write(6,*) "cmat before transformation"
c~       do i = 1, size(cmat,1)
c~           write(6,'(40G12.4)')  cmat(i,:)
c~       end do
...
c~       write(6,*) "cmat after transformation"
c~       do i = 1, size(cmat,1)
c~           write(6,'(40G12.4)')  cmat(i,:)
c~       end do
...
c~       write(6,*) "kapmat before transformation"
c~       do i = 1, size(kapmat,1)
c~           write(6,'(40G12.4)')  kapmat(i,:)
c~       end do
...
c~       write(6,*) "kapmat after transformation"
c~       do i = 1, size(kapmat,1)
c~           write(6,'(40G12.4)')  kapmat(i,:)
c~       end do
...
c~       write(6,*) "grdmat before transformation"
c~       do i = 1, size(grdmat,1)
c~           write(6,'(40G12.4)')  grdmat(i,:)
c~       end do
...
c~       write(6,*) "grdmat after transformation"
c~       do i = 1, size(grdmat,1)
c~           write(6,'(40G12.4)')  grdmat(i,:)
c~       end do
